    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-6">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
        ...
        <div className="flex gap-3">
          <button onClick={onCancel} disabled={loading} className="flex-1 border border-gray-200 rounded-xl py-3 text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">Cancel</button>
  ...
  return (
    <div className="fixed inset-0 z-40" onClick={onClose}>
      <div className="absolute top-14 right-4 bg-white rounded-2xl shadow-xl border border-gray-100 p-4 w-52" onClick={(e) => e.stopPropagation()}>
        ...
        <button onClick={() => { router.push('/admin/analytics'); onClose() }} className="flex items-center gap-3 w-full py-2.5 text-sm text-gray-600 hover:text-gray-900 transition-colors">
        ...
        <div className="flex items-center gap-2">
          {searchOpen ? (
            <input
              ...
              className="text-sm outline-none border-b border-gray-200 pb-0.5 w-36 md:w-56 text-gray-800 placeholder:text-gray-300 bg-transparent"
            />
          ) : (
